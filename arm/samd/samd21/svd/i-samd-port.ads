...
package Interfaces.SAMD.PORT is
   pragma Preelaborate;
   ...
   subtype WRCONFIG_PINMASK_Field is Interfaces.SAMD.UInt16;
   subtype WRCONFIG_PMUX_Field is Interfaces.SAMD.UInt4;
   ...
   type PMUX_Register is record
      --  Peripheral Multiplexing Even
      PMUXE : PMUX0_PMUXESelect := Interfaces.SAMD.PORT.A;
      --  Peripheral Multiplexing Odd
      PMUXO : PMUX0_PMUXOSelect := Interfaces.SAMD.PORT.A;
   end record
   ...
   type PORT_Peripheral is record
      --  Data Direction
      DIR0      : aliased Interfaces.SAMD.UInt32;
      --  Data Direction Clear
      DIRCLR0   : aliased Interfaces.SAMD.UInt32;
      --  Data Direction Set
      DIRSET0   : aliased Interfaces.SAMD.UInt32;
      --  Data Direction Toggle
      DIRTGL0   : aliased Interfaces.SAMD.UInt32;
      --  Data Output Value
      OUT0      : aliased Interfaces.SAMD.UInt32;
      --  Data Output Value Clear
      OUTCLR0   : aliased Interfaces.SAMD.UInt32;
      --  Data Output Value Set
      OUTSET0   : aliased Interfaces.SAMD.UInt32;
      --  Data Output Value Toggle
      OUTTGL0   : aliased Interfaces.SAMD.UInt32;
      --  Data Input Value
      IN0       : aliased Interfaces.SAMD.UInt32;
      --  Control
      CTRL0     : aliased Interfaces.SAMD.UInt32;
      --  Write Configuration
      ...
      --  Data Direction
      DIR1      : aliased Interfaces.SAMD.UInt32;
      --  Data Direction Clear
      DIRCLR1   : aliased Interfaces.SAMD.UInt32;
      --  Data Direction Set
      DIRSET1   : aliased Interfaces.SAMD.UInt32;
      --  Data Direction Toggle
      DIRTGL1   : aliased Interfaces.SAMD.UInt32;
      --  Data Output Value
      OUT1      : aliased Interfaces.SAMD.UInt32;
      --  Data Output Value Clear
      OUTCLR1   : aliased Interfaces.SAMD.UInt32;
      --  Data Output Value Set
      OUTSET1   : aliased Interfaces.SAMD.UInt32;
      --  Data Output Value Toggle
      OUTTGL1   : aliased Interfaces.SAMD.UInt32;
      --  Data Input Value
      IN1       : aliased Interfaces.SAMD.UInt32;
      --  Control
      CTRL1     : aliased Interfaces.SAMD.UInt32;
      --  Write Configuration
