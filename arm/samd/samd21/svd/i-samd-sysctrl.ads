...
package Interfaces.SAMD.SYSCTRL is
   pragma Preelaborate;
   ...
   type SYSCTRL_INTENCLR_Register is record
      ...
      --  unspecified
      Reserved_12_14 : Interfaces.SAMD.UInt3 := 16#0#;
   ...
   type SYSCTRL_PCLKSR_Register is record
      ...
      B33SRDY        : Boolean;
      --  unspecified
      Reserved_12_14 : Interfaces.SAMD.UInt3;
      ...
      DPLLLTO        : Boolean;
      --  unspecified
      Reserved_18_31 : Interfaces.SAMD.UInt14;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype SYSCTRL_XOSC_STARTUP_Field is Interfaces.SAMD.UInt4;

   --  External Multipurpose Crystal Oscillator (XOSC) Control
   type SYSCTRL_XOSC_Register is record
      --  unspecified
      Reserved_0_0 : Interfaces.SAMD.Bit := 16#0#;
      --  Oscillator Enable
      ...
      --  Oscillator Gain
      GAIN         : XOSC_GAINSelect := Interfaces.SAMD.SYSCTRL.Val_0;
   ...
   subtype SYSCTRL_XOSC32K_STARTUP_Field is Interfaces.SAMD.UInt3;
   ...
   type SYSCTRL_XOSC32K_Register is record
      ...
      --  unspecified
      Reserved_11_11 : Interfaces.SAMD.Bit := 16#0#;
      --  Write Lock
      WRTLOCK        : Boolean := False;
      --  unspecified
      Reserved_13_15 : Interfaces.SAMD.UInt3 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 16,
          Bit_Order => System.Low_Order_First;
   ...
   subtype SYSCTRL_OSC32K_STARTUP_Field is Interfaces.SAMD.UInt3;
   subtype SYSCTRL_OSC32K_CALIB_Field is Interfaces.SAMD.UInt7;
   ...
   type SYSCTRL_OSC32K_Register is record
      ...
      EN1K           : Boolean := False;
      --  unspecified
      Reserved_4_5   : Interfaces.SAMD.UInt2 := 16#0#;
      --  Run in Standby
      RUNSTDBY       : Boolean := False;
      --  On Demand Control
      ONDEMAND       : Boolean := True;
      ...
      --  unspecified
      Reserved_23_31 : Interfaces.SAMD.UInt9 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype SYSCTRL_OSCULP32K_CALIB_Field is Interfaces.SAMD.UInt5;
   ...
   subtype SYSCTRL_OSC8M_CALIB_Field is Interfaces.SAMD.UInt12;
   ...
   type SYSCTRL_OSC8M_Register is record
      ...
      ENABLE         : Boolean := True;
      --  unspecified
      Reserved_2_5   : Interfaces.SAMD.UInt4 := 16#0#;
      --  Run in Standby
      RUNSTDBY       : Boolean := False;
      --  On Demand Control
      ONDEMAND       : Boolean := True;
      --  Oscillator Prescaler
      PRESC          : OSC8M_PRESCSelect := Interfaces.SAMD.SYSCTRL.Val_3;
      --  unspecified
      ...
      --  Oscillator Frequency Range
      FRANGE         : OSC8M_FRANGESelect := Interfaces.SAMD.SYSCTRL.Val_2;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   type SYSCTRL_DFLLCTRL_Register is record
      ...
      --  unspecified
      Reserved_12_15 : Interfaces.SAMD.UInt4 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 16,
          Bit_Order => System.Low_Order_First;
   ...
   subtype SYSCTRL_DFLLVAL_FINE_Field is Interfaces.SAMD.UInt10;
   subtype SYSCTRL_DFLLVAL_COARSE_Field is Interfaces.SAMD.UInt6;
   subtype SYSCTRL_DFLLVAL_DIFF_Field is Interfaces.SAMD.UInt16;
   ...
   subtype SYSCTRL_DFLLMUL_MUL_Field is Interfaces.SAMD.UInt16;
   subtype SYSCTRL_DFLLMUL_FSTEP_Field is Interfaces.SAMD.UInt10;
   subtype SYSCTRL_DFLLMUL_CSTEP_Field is Interfaces.SAMD.UInt6;
   ...
   type SYSCTRL_DFLLSYNC_Register is record
      --  unspecified
      Reserved_0_6 : Interfaces.SAMD.UInt7 := 16#0#;
   ...
   subtype SYSCTRL_BOD33_LEVEL_Field is Interfaces.SAMD.UInt6;
   ...
   type SYSCTRL_BOD33_Register is record
      ...
      HYST           : Boolean := False;
      --  BOD33 Action
      ACTION         : BOD33_ACTIONSelect := Interfaces.SAMD.SYSCTRL.None;
      --  unspecified
      ...
      CEN            : Boolean := False;
      --  unspecified
      Reserved_10_11 : Interfaces.SAMD.UInt2 := 16#0#;
      --  Prescaler Select
      PSEL           : BOD33_PSELSelect := Interfaces.SAMD.SYSCTRL.Div2;
      --  BOD33 Threshold Level
      LEVEL          : SYSCTRL_BOD33_LEVEL_Field := 16#0#;
      --  unspecified
      Reserved_22_31 : Interfaces.SAMD.UInt10 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   type SYSCTRL_VREG_Register is record
      --  unspecified
      Reserved_0_5   : Interfaces.SAMD.UInt6 := 16#0#;
      --  Run in Standby
      RUNSTDBY       : Boolean := False;
      --  unspecified
      Reserved_7_12  : Interfaces.SAMD.UInt6 := 16#0#;
   ...
   subtype SYSCTRL_VREF_CALIB_Field is Interfaces.SAMD.UInt11;
   ...
   subtype SYSCTRL_DPLLRATIO_LDR_Field is Interfaces.SAMD.UInt12;
   subtype SYSCTRL_DPLLRATIO_LDRFRAC_Field is Interfaces.SAMD.UInt4;
   ...
   type SYSCTRL_DPLLRATIO_Register is record
      ...
      --  unspecified
      Reserved_20_31 : Interfaces.SAMD.UInt12 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype SYSCTRL_DPLLCTRLB_DIV_Field is Interfaces.SAMD.UInt11;

   --  DPLL Control B
   type SYSCTRL_DPLLCTRLB_Register is record
      --  Proportional Integral Filter Selection
      FILTER         : DPLLCTRLB_FILTERSelect :=
                        Interfaces.SAMD.SYSCTRL.Default;
      --  Low-Power Enable
      LPEN           : Boolean := False;
      --  Wake Up Fast
      WUF            : Boolean := False;
      --  Reference Clock Selection
      REFCLK         : DPLLCTRLB_REFCLKSelect := Interfaces.SAMD.SYSCTRL.Ref0;
      --  unspecified
      Reserved_6_7   : Interfaces.SAMD.UInt2 := 16#0#;
      --  Lock Time
   ...
   type SYSCTRL_DPLLSTATUS_Register is record
      ...
      DIV          : Boolean;
      --  unspecified
      Reserved_4_7 : Interfaces.SAMD.UInt4;
   end record
     with Volatile_Full_Access, Object_Size => 8,
          Bit_Order => System.Low_Order_First;
