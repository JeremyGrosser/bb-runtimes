...
package Interfaces.SAMD.GCLK is
   pragma Preelaborate;
   ...
   type GCLK_CLKCTRL_Register is record
      --  Generic Clock Selection ID
      ID             : CLKCTRL_IDSelect := Interfaces.SAMD.GCLK.Dfll48;
      --  unspecified
      Reserved_6_7   : Interfaces.SAMD.UInt2 := 16#0#;
      --  Generic Clock Generator
      GEN            : CLKCTRL_GENSelect := Interfaces.SAMD.GCLK.Gclk0;
      --  unspecified
      Reserved_12_13 : Interfaces.SAMD.UInt2 := 16#0#;
      --  Clock Enable
      CLKEN          : Boolean := False;
      --  Write Lock
   ...
   subtype GCLK_GENCTRL_ID_Field is Interfaces.SAMD.UInt4;
   ...
   type GCLK_GENCTRL_Register is record
      ...
      --  Source Select
      SRC            : GENCTRL_SRCSelect := Interfaces.SAMD.GCLK.Xosc;
      --  unspecified
   ...
   subtype GCLK_GENDIV_ID_Field is Interfaces.SAMD.UInt4;
   subtype GCLK_GENDIV_DIV_Field is Interfaces.SAMD.UInt16;
