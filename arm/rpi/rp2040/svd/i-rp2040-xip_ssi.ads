...
package Interfaces.RP2040.XIP_SSI is
   pragma Preelaborate;
   ...
   subtype CTRLR0_DFS_Field is Interfaces.RP2040.UInt4;
   subtype CTRLR0_FRF_Field is Interfaces.RP2040.UInt2;
   ...
   subtype CTRLR0_CFS_Field is Interfaces.RP2040.UInt4;
   subtype CTRLR0_DFS_32_Field is Interfaces.RP2040.UInt5;
   ...
   type CTRLR0_Register is record
      ...
      SCPOL          : Boolean := False;
      --  Transfer mode
      TMOD           : CTRLR0_TMOD_Field :=
                        Interfaces.RP2040.XIP_SSI.TX_AND_RX;
      --  Slave output enable
      ...
      --  SPI frame format
      SPI_FRF        : CTRLR0_SPI_FRF_Field := Interfaces.RP2040.XIP_SSI.STD;
      --  unspecified
      Reserved_23_23 : Interfaces.RP2040.Bit := 16#0#;
   ...
   subtype CTRLR1_NDF_Field is Interfaces.RP2040.UInt16;
   ...
   type CTRLR1_Register is record
      ...
      --  unspecified
      Reserved_16_31 : Interfaces.RP2040.UInt16 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype BAUDR_SCKDV_Field is Interfaces.RP2040.UInt16;
   ...
   subtype TXFTLR_TFT_Field is Interfaces.RP2040.Byte;
   ...
   subtype RXFTLR_RFT_Field is Interfaces.RP2040.Byte;
   ...
   subtype TXFLR_TFTFL_Field is Interfaces.RP2040.Byte;
   ...
   type TXFLR_Register is record
      ...
      --  unspecified
      Reserved_8_31 : Interfaces.RP2040.UInt24;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype RXFLR_RXTFL_Field is Interfaces.RP2040.Byte;
   ...
   type SR_Register is record
      ...
      DCOL          : Boolean;
      --  unspecified
      Reserved_7_31 : Interfaces.RP2040.UInt25;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   type DMACR_Register is record
      ...
      TDMAE         : Boolean := False;
      --  unspecified
      Reserved_2_31 : Interfaces.RP2040.UInt30 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype DMATDLR_DMATDL_Field is Interfaces.RP2040.Byte;
   ...
   subtype DMARDLR_DMARDL_Field is Interfaces.RP2040.Byte;
   ...
   subtype RX_SAMPLE_DLY_RSD_Field is Interfaces.RP2040.Byte;
   ...
   subtype SPI_CTRLR0_ADDR_L_Field is Interfaces.RP2040.UInt4;
   ...
   subtype SPI_CTRLR0_WAIT_CYCLES_Field is Interfaces.RP2040.UInt5;
   subtype SPI_CTRLR0_XIP_CMD_Field is Interfaces.RP2040.Byte;

   --  SPI control
   type SPI_CTRLR0_Register is record
      --  Address and instruction transfer format
      TRANS_TYPE     : SPI_CTRLR0_TRANS_TYPE_Field :=
                        Interfaces.RP2040.XIP_SSI.Val_1C1A;
      --  Address length (0b-60b in 4b increments)
      ADDR_L         : SPI_CTRLR0_ADDR_L_Field := 16#0#;
      --  unspecified
      Reserved_6_7   : Interfaces.RP2040.UInt2 := 16#0#;
      --  Instruction length (0/4/8/16b)
      INST_L         : SPI_CTRLR0_INST_L_Field :=
                        Interfaces.RP2040.XIP_SSI.NONE;
      --  unspecified
      Reserved_10_10 : Interfaces.RP2040.Bit := 16#0#;
      ...
      --  unspecified
      Reserved_19_23 : Interfaces.RP2040.UInt5 := 16#0#;
   ...
   subtype TXD_DRIVE_EDGE_TDE_Field is Interfaces.RP2040.Byte;
   ...
   type XIP_SSI_Peripheral is record
      ...
      IDR            : aliased Interfaces.RP2040.UInt32;
      --  Version ID
      SSI_VERSION_ID : aliased Interfaces.RP2040.UInt32;
      --  Data Register 0 (of 36)
      DR0            : aliased Interfaces.RP2040.UInt32;
      --  RX sample delay
